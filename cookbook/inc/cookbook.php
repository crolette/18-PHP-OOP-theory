...
$lemon_chicken->addIngredient("garlic, chopped", 2, "soup spoon");
$lemon_chicken->addIngredient("lemon juice", .25, "Cup");
$lemon_chicken->addIngredient("sugar", .5, "coffee spoon");
$lemon_chicken->addIngredient("parsley", 2, "coffee spoon");
$lemon_chicken->addIngredient("oregano", 2, "coffee spoon");
$lemon_chicken->addIngredient("basil", 1, "soup spoon");
...
$granola_muffins->addIngredient("vanilla", 1, "coffee spoon");
$granola_muffins->addIngredient("white vinegar", .5, "coffee spoon");
$granola_muffins->addIngredient("granola", 2, "cup");
$granola_muffins->addIngredient("flour", 1, "cup");
$granola_muffins->addIngredient("instant protein", 4, "soup spoon");
$granola_muffins->addIngredient("baking powder", 2, "coffee spoon");
$granola_muffins->addIngredient("cinnamon", 2, "coffee spoon");
$granola_muffins->addIngredient("baking soda", .5, "coffee spoon");
$granola_muffins->addIngredient("salt", .5, "coffee spoon");
...
$belgian_waffles->addIngredient("vanilla", 2, "coffee spoon");
$belgian_waffles->addIngredient("flour", 2, "cup");
$belgian_waffles->addIngredient("baking powder", 1, "soup spoon");
...
$belgian_waffles->setSource("The crazy cooker");
...
$pepper_casserole->addIngredient("Ground Turkey", 1, "kg");
...
$pepper_casserole->setSource("The crazy cooker");
$pepper_casserole->addTag("dinner");


$lasagna = new Recipe("Lasagna");

$lasagna->addIngredient("Lasagna Noodles", 500, "g");
$lasagna->addIngredient("Sweet Italian Sausage", 500, "g");
...
$lasagna->setSource("The crazy cooker");
...
$pistachio_duck->setSource("Donald");
...
$chili_pork->addIngredient("Garlic, chopped", 2, "coffee spoon");
$chili_pork->addIngredient("Cilantro", 3, "soup spoon");
$chili_pork->addIngredient("Chicken stock", 2, "cup");
$chili_pork->addIngredient("Lime Juice", 3, "soup spoon");
$chili_pork->addIngredient("Red onion, diced", 3, "soup spoon");
$chili_pork->addIngredient("Olive oil", 2, "soup spoon");
...
$crab_cakes->addIngredient("Cilantro", 2, "soup spoon");
...
$crab_cakes->addIngredient("Crab meat", 1, "kg");
...
$silver_dollar_cakes->addIngredient("Salt", .5, "coffee spoon");
$silver_dollar_cakes->addIngredient("Baking soda", .5, "coffee spoon");
$silver_dollar_cakes->addIngredient("Cake flour", .25, "cup");
$silver_dollar_cakes->addIngredient("Sour cream", 2, "cup");
$silver_dollar_cakes->addIngredient("Sugar", 3, "soup spoon");
...
$silver_dollar_cakes->setSource("General MacMac");
...
$french_toast->addIngredient("Whole eggs", 250, "g");
$french_toast->addIngredient("Milk", 1, "cup");
$french_toast->addIngredient("Cinnamon", .5, "coffee spoon");
$french_toast->addIngredient("Nutmeg", .25, "coffee spoon");
...
$french_toast->setSource("Jean-Pierre François");
...
$corn_beef_hash->addIngredient("Cornbeef, small diced", 1, "kg");
...
$granola->addIngredient("Rolled oats", 250, "g");
$granola->addIngredient("Rolled wheat", 1, "cup");
$granola->addIngredient("Rolled rye", 1, "cup");
$granola->addIngredient("Rolled barley", 1, "cup");
$granola->addIngredient("Nutmeg", 1, "coffee spoon");
$granola->addIngredient("Cinnamon", .5, "coffee spoon");
$granola->addIngredient("Salt", .125, "coffee spoon");
...
$spicy_omelette->addIngredient("Pepper-Jack cheese, shredded", 3, "soup spoon");
...
$scones->addIngredient("Baking powder", 2.5, "coffee spoon");
$scones->addIngredient("Salt", 1, "coffee spoon");
$scones->addIngredient("Baking soda", .5, "coffee spoon");
$scones->addIngredient("Orange zest", 1, "soup spoon");
...
$scones->addIngredient("Orange juice, freshly squeezed", 4, "coffee spoon");
